      ...
      <div className="container">
        <div className={styles.contactContent}>
          <div className={styles.contactText}>
            ...
            <p className={styles.contactDescription}>
              Whether you're looking for a developer to join your team, need help with a physics problem, 
              or want to discuss the finer points of D&D mechanics, I'd love to hear from you.
            </p>
          </div>
          <div className={styles.contactActions}>
            <Link
              className={clsx('button button--primary button--lg', styles.contactButton)}
              href="mailto:hello@matthewholden.dev"
            >
              Get In Touch
            </Link>
            <Link
        ...
        <div className={styles.socialLinks}>
          ...
          <div className={styles.socialIcons}>
            ...
            <Link
              href="https://linkedin.com/in/matthew-holden"
              className={styles.socialLink}
              title="LinkedIn"
            >
            ...
            <Link
              href="https://twitter.com/heisenbergsdev"
              className={styles.socialLink}
              title="Twitter"
            >
